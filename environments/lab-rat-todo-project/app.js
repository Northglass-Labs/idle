const STORAGE_KEY = "idle-sample-todo-items";

const seedItems = [
  { id: crypto.randomUUID(), text: "Review the sample project", done: false },
  { id: crypto.randomUUID(), text: "Try the completed-items filter", done: true },
  { id: crypto.randomUUID(), text: "Make one small accessible improvement", done: false },
  { id: crypto.randomUUID(), text: "Verify local persistence", done: false },
];
