...
This document defines Idle's structured decrypted event stream for coding-agent
sessions. Current sessions use this protocol; readers retain the documented
legacy message shapes for existing records.

For WebSocket transport, encryption, ordering, and recovery, see the
