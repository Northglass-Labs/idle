...
import { shouldRunLiveAgentIntegration } from './src/testing/liveAgentIntegration'

const liveAgentProjects = [
    {
        extends: true,
        test: {
            name: 'integration-live-empty',
    ...
    },
    {
        extends: true,
        test: {
            name: 'integration-live-plan-mode',
            fileParallelism: false,
            hookTimeout: 120_000,
            maxWorkers: 1,
            minWorkers: 1,
    ...
    },
    {
        extends: true,
        test: {
            name: 'integration-live-authenticated',
            fileParallelism: false,
            hookTimeout: 120_000,
            maxWorkers: 1,
            minWorkers: 1,
...
export default defineConfig({
    test: {
        ...
        projects: [
            ...
            },
            {
                ...
                test: {
                    ...
                    include: [
                        ...
                        'src/sandbox/processBoundary.integration.test.ts',
                    ],
                    setupFiles: ['./src/testing/integration.setup.empty.ts'],
                    sequence: {
                        groupOrder: 1,
            ...
            ...(shouldRunLiveAgentIntegration() ? liveAgentProjects : []),
        ],
        coverage: {
            provider: 'v8',
