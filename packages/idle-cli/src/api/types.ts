import { z } from 'zod'
import { AuthenticatedMessageIdentitySchema } from '@northglass/idle-wire';
...
export { CreateSessionResponseSchema } from '@northglass/idle-wire';
...
export const MachineMetadataSchema = z.object({
  ...
  resumeSupport: z.object({
    ...
    requiresIdleAgentAuth: z.boolean(),
    idleAgentAuthenticated: z.boolean(),
    detectedAt: z.number(),
  }).optional(),
})
...
export const MessageMetaSchema = z.object({
  ...
  // Reasoning effort level for this turn (Claude --effort flag, Codex model_reasoning_effort).
  // Values: low | medium | high | xhigh | max. Null = reset to default.
    ...
    data: z.object({
      ...
      ev: z.object({
        ...
        image: z.object({
          ...
          // Keep this aligned with the app so valid native picker events are
          // not rejected before the attachment reaches Claude.
