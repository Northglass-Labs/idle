...
export interface EnhancedMode {
    ...
    model?: string;
    /** Authenticated sender message ID used to correlate this exact remote turn. */
    requestId?: string;
    ...
    /**
     * Reasoning effort level for this turn, passed through to the Claude Agent
     * SDK as the `effort` option (drives the API's `output_config.effort`).
     * Values: low, medium, high, xhigh, max. Undefined = Claude's default.
     */
    effort?: ClaudeEffort;
}
