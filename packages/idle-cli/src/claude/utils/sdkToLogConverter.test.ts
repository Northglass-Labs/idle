...
describe('SDKToLogConverter', () => {
    ...
    describe('User messages', () => {
        it('should convert SDK user message to log format', () => {
            ...
            expect(logMessage).not.toHaveProperty('cwd')
            expect(logMessage).not.toHaveProperty('gitBranch')
        })
    ...
    describe('Assistant messages', () => {
        ...
        it('should not forward provider request identifiers', () => {
            ...
            expect(logMessage).not.toHaveProperty('requestId')
        })
    ...
    describe('System messages', () => {
        it('should convert SDK system message to log format', () => {
            const sdkMessage = {
                ...
                cwd: '/project',
                tools: ['bash', 'edit'],
                providerPrivateField: 'must-not-be-forwarded'
            ...
            expect(logMessage).not.toHaveProperty('cwd')
            expect(logMessage).not.toHaveProperty('providerPrivateField')
        })

        it('drops unknown SDK message variants instead of forwarding arbitrary provider fields', () => {
            const logMessage = converter.convert({
                type: 'provider_private_variant',
                privatePayload: 'must-not-be-forwarded',
