...
import { IdSchema, EncryptedBlobSchema, FreeTextSchema } from "@/app/api/routes/_schemas";
...
export function accessKeysRoutes(app: Fastify) {
    ...
    app.get('/v1/access-keys/:sessionId/:machineId', {
        ...
        try {
            ...
            log({ module: 'api', level: 'error' }, 'Failed to get access key');
    ...
    app.post('/v1/access-keys/:sessionId/:machineId', {
        ...
        try {
            ...
            log({ module: 'access-keys' }, 'Created new access key');
            ...
            log({ module: 'api', level: 'error' }, 'Failed to create access key');
    ...
    app.put('/v1/access-keys/:sessionId/:machineId', {
            ...
            response: {
                200: z.union([
                    ...
                    z.object({
                        ...
                        currentData: EncryptedBlobSchema
                    })
                ]),
                404: z.object({
        ...
        try {
            ...
            log({ module: 'access-keys' }, 'Updated access key');
            ...
            log({ module: 'api', level: 'error' }, 'Failed to update access key');
