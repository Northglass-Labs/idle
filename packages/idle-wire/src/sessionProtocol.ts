/**
 * Validated event envelopes shared by the CLI, relay clients, and app. Turn
 * identifiers group lifecycle and output events; optional subagent identifiers
 * are restricted to cuid2 values before an envelope crosses a trust boundary.
 */
