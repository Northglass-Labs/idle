  ...
  try {
    if (Platform.OS === 'web') {
      ...
      try {
        ...
        console.error('Web microphone permission denied');
...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Idle needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Idle needs access to your microphone for voice chat. Please enable microphone access in your device settings.';
