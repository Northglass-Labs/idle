...
// Minimum released Idle CLI version that supports this app's session protocol.
// This is the Idle package version, not the historical upstream version line.
export const MINIMUM_CLI_VERSION = '0.4.13';
