...
describe('buildResumeCommand', () => {
    it('builds a Claude resume command that enters the session directory first', () => {
        ...
        })).toBe(`cd '/tmp/project' && idle claude --resume 11111111-1111-4111-8111-111111111111`);
    });
    ...
    it('builds a Windows Codex resume command using PowerShell directory navigation', () => {
        ...
        })).toBe(`Set-Location -LiteralPath 'C:\\Users\\test\\project'; idle codex --resume 019ccca5-726b-7c61-b914-16de27dfab6e`);
    });
    ...
    it('falls back to the bare resume command when no path is available', () => {
        expect(buildResumeCommand({
            flavor: 'claude',
            claudeSessionId: '11111111-1111-4111-8111-111111111111',
        })).toBe('idle claude --resume 11111111-1111-4111-8111-111111111111');
    });
...
describe('buildResumeCommandBlock', () => {
    it('builds copyable two-line CLI instructions when a path is available', () => {
        expect(buildResumeCommandBlock({
            ...
            lines: [
                `cd '/tmp/project'`,
                'idle claude --resume 11111111-1111-4111-8111-111111111111',
            ],
    ...
    it('falls back to a single-line command block when no path is available', () => {
        expect(buildResumeCommandBlock({
            ...
            lines: ['idle claude --resume 11111111-1111-4111-8111-111111111111'],
            copyText: 'idle claude --resume 11111111-1111-4111-8111-111111111111',
        });
    });
