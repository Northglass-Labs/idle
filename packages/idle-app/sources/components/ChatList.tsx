...
const ListFooter = React.memo((props: { sessionId: string }) => {
    ...
    const { controlledByUser } = getOperationalSessionIndicators(session);
    return (
...
const ChatListInternal = React.memo((props: {
    ...
    const hasPendingPermission = session
        ? getOperationalSessionIndicators(session).hasPendingPermissions
        : false;
