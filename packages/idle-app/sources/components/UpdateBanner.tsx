...
export const UpdateBanner = React.memo(() => {
    ...
    if (updateUrl) {
        // openLink force-routes App Store / Play Store URLs externally
        // regardless of the user's linksOpenIn setting (in-app browser
        // can't actually install the update).
        const handleOpenStore = () => openLink(updateUrl);
