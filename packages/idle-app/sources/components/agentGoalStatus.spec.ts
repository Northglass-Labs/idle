...
vi.mock('@/sync/storage', () => ({
    ...
    getOperationalAgentState: (value: unknown) => trust.agentState ? value : null,
}));
...
describe('resolveVisibleAgentGoalStatus', () => {
    ...
    it('hides goal controls when their coordinates are display-only legacy data', () => {
        trust.metadata = false;
        trust.agentState = false;
