...
export const PermissionFooter: React.FC<PermissionFooterProps> = ({ permission, sessionId, toolName, toolInput, metadata }) => {
    ...
    const operationalMetadata = getOperationalSessionMetadata(metadata);
    // Tool names come from authenticated agent state. Legacy display metadata
    // cannot switch approval protocol semantics.
    const isCodex = operationalMetadata?.flavor === 'codex' || toolName.startsWith('Codex');
    ...
    const handleApprove = async () => {
        ...
        try {
            ...
            console.error('Failed to approve permission');
        } finally {
    ...
    const handleApproveAllEdits = async () => {
        ...
        try {
            ...
            console.error('Failed to approve all edits');
        } finally {
    ...
    const handleBypassPermissions = async () => {
        ...
        try {
            ...
            console.error('Failed to bypass permissions');
        } finally {
    ...
    const handleApproveForSession = async () => {
        ...
        try {
            ...
            console.error('Failed to approve for session');
        } finally {
    ...
    const handleDeny = async () => {
        ...
        try {
            ...
            console.error('Failed to deny permission');
        } finally {
            setLoadingButton(null);
        }
    };
    ...
    const handleCodexAbort = async () => {
        ...
        try {
            ...
            console.error('Failed to abort permission');
        } finally {
            setLoadingButton(null);
        }
    };
