        ...
        <ItemList style={{ paddingTop: 0 }}>
            ...
            >
                <Item
                    ...
                    longDescription="Sets the language ElevenLabs uses to recognize your speech. Pick the language you actually talk in. Mixing languages mid-utterance can confuse recognition; pick your dominant one."
            ...
            >
                <Item
                    ...
                    longDescription="Enter an ElevenLabs Agent ID to select a custom voice agent. An Agent ID is not an API key. Direct Connection stays off until you enable it separately."
                ...
                <Item
                    ...
                    longDescription="Connect directly to the configured ElevenLabs agent without requesting a voice token from the Idle server. Requires a valid custom Agent ID. Enable only when the agent is configured for direct client access."
