...
// Alert, confirmation, and prompt calls share one cross-platform branded modal
// pipeline, including secure-text, numeric, and email-address inputs.
// If the provider is not mounted during early bootstrap, calls fail closed by
// logging a fixed diagnostic code and returning without presenting native UI.
