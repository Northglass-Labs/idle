 ...
 *
 * This platform-specific module uses crypto.subtle directly so the web bundle
 * does not load the native abstraction or require a runtime Platform.OS branch.
 *
